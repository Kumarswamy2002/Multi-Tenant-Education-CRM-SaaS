...
/**
 * Dropdown bell notification tray with unread counters and mark all read
 * Enterprise Design System Component for counselor-portal
 */
export const NotificationCenter: React.FC<NotificationCenterProps> = ({
  ...
  return (
    ...
    >
      ...
      {label || children || "NotificationCenter Component"}
    </div>
  );
};
