"""
Examination Seating Matrix, Hall Capacity, Roll Number Sorter
...
class ExamSeatingAllocator:
    """Algorithmic implementation for Examination Seating Matrix, Hall Capacity, Roll Number Sorter."""
