"""
Student self-service endpoints: Profile, Enrolled courses, Live timetable, Fee payment
...
router = APIRouter(prefix="/portal-student-api", tags=["Portal Student Api"])
...
def module_health_check(
    ...
    return APIResponse(
        success=True,
        message="portal_student_api router online",
        data={"tenant_id": tenant_id, "status": "healthy", "service": "portal_student_api"}
    )
