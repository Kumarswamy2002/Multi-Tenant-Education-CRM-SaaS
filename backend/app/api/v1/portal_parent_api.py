"""
Parent portal endpoints: Ward academic progress, Attendance tracking, Fee receipts
...
router = APIRouter(prefix="/portal-parent-api", tags=["Portal Parent Api"])
...
def module_health_check(
    ...
    return APIResponse(
        success=True,
        message="portal_parent_api router online",
        data={"tenant_id": tenant_id, "status": "healthy", "service": "portal_parent_api"}
    )
