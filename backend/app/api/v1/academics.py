"""
Academic operations: Courses, Programs, Sections, Enrollments, Attendance, Grading
...
def module_health_check(
    ...
    return APIResponse(
        success=True,
        message="academics router online",
        data={"tenant_id": tenant_id, "status": "healthy", "service": "academics"}
    )
