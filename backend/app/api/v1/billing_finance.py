"""
Tuition Billing: Invoicing, Payment gateways, Installments, Scholarships, Financial aid
...
router = APIRouter(prefix="/billing-finance", tags=["Billing Finance"])
...
def module_health_check(
    ...
    return APIResponse(
        success=True,
        message="billing_finance router online",
        data={"tenant_id": tenant_id, "status": "healthy", "service": "billing_finance"}
    )
