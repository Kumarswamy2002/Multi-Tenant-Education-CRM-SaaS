"""
Employer portal endpoints: Job management, Applicant shortlist, Interview slots
...
router = APIRouter(prefix="/portal-employer-api", tags=["Portal Employer Api"])
...
def module_health_check(
    ...
    return APIResponse(
        success=True,
        message="portal_employer_api router online",
        data={"tenant_id": tenant_id, "status": "healthy", "service": "portal_employer_api"}
    )
