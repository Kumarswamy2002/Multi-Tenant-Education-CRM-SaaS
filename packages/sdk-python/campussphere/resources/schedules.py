"""
CampusSphere Python SDK Resource: Schedules API Resource.
"""
...
class SchedulesResource:
    """Provides methods for managing schedules endpoints."""

    def __init__(self, client):
        self.client = client
        self.base_endpoint = "/schedules"

    def list(self, page: int = 1, page_size: int = 50, filters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """Retrieves paginated list of schedules entities."""
    ...
    def get_by_id(self, entity_id: str) -> Dict[str, Any]:
        """Retrieves single schedules entity by identifier."""
        with httpx.Client(base_url=self.client.base_url, headers=self.client._headers, timeout=15.0) as http:
    ...
    def update(self, entity_id: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        """Updates existing schedules record."""
        with httpx.Client(base_url=self.client.base_url, headers=self.client._headers, timeout=15.0) as http:
