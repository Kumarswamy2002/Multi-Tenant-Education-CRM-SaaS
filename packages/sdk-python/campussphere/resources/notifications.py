"""
CampusSphere Python SDK Resource: Notifications API Resource.
"""
...
class NotificationsResource:
    """Provides methods for managing notifications endpoints."""

    def __init__(self, client):
        self.client = client
        self.base_endpoint = "/notifications"

    def list(self, page: int = 1, page_size: int = 50, filters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """Retrieves paginated list of notifications entities."""
    ...
    def get_by_id(self, entity_id: str) -> Dict[str, Any]:
        """Retrieves single notifications entity by identifier."""
        with httpx.Client(base_url=self.client.base_url, headers=self.client._headers, timeout=15.0) as http:
    ...
    def create(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        """Creates new notifications record."""
        with httpx.Client(base_url=self.client.base_url, headers=self.client._headers, timeout=15.0) as http:
    ...
    def update(self, entity_id: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        """Updates existing notifications record."""
        with httpx.Client(base_url=self.client.base_url, headers=self.client._headers, timeout=15.0) as http:
    ...
    def delete(self, entity_id: str) -> Dict[str, Any]:
        """Soft-deletes notifications record."""
        with httpx.Client(base_url=self.client.base_url, headers=self.client._headers, timeout=15.0) as http:
