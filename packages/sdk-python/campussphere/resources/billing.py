"""
CampusSphere Python SDK Resource: Billing API Resource.
"""
...
class BillingResource:
    """Provides methods for managing billing endpoints."""

    def __init__(self, client):
        self.client = client
        self.base_endpoint = "/billing"

    def list(self, page: int = 1, page_size: int = 50, filters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """Retrieves paginated list of billing entities."""
    ...
    def get_by_id(self, entity_id: str) -> Dict[str, Any]:
        """Retrieves single billing entity by identifier."""
        with httpx.Client(base_url=self.client.base_url, headers=self.client._headers, timeout=15.0) as http:
